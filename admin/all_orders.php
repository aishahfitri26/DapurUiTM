...
if ($result->num_rows > 0) {
    ...
    while($row = $result->fetch_assoc()) {
        ...
        <td><button class='delete-btn' data-id='" . $row["order_id"]. "'>Delete</button> <a href='order_update.php?order_id=" . $row["order_id"]. "'><button class='update-btn'>Update</button></a></td></tr>";
